...
Route::get('/editar-perfil/password', [PerfilController::class, 'indexPassword'])->name('perfil.password.index');
Route::post('/editar-perfil/password', [PerfilController::class, 'update'])->name('perfil.password.update');
